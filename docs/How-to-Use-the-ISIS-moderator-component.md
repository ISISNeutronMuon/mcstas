...
If you don't have the latest version please download [commudus_1.comp](https://www.dropbox.com/s/olhzq8kn5jopuui/Commudus_1.comp?dl=0)

Correct example of its use;

COMPONENT Source =   ViewModISISver1(Face="msMerlin_160.mcstas", E0 = E_min, E1 = E_max, tally=8.4, modPosition=0, modXsize=0.12, modZsize = 0.12,  xw = 0.094, yh = 0.094, dist = 1.6)
 ...
 * tally:    (m)   Distance from shutter face to point tally in full simulation (leave as 8.4m)
 * modPosition:    Leave this as 0 (defines moderator at true moderator position)
